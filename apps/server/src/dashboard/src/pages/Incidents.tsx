    ...
    <div className="space-y-5">
      ...
      {loading && incidents.length === 0 ? (
        ...
        <div className="card p-8 text-center">
          ...
          <p className="text-xs text-gray-600 mt-1">That's a good thing! Your app is running smoothly.</p>
        </div>
      ) : (
        <div className="card divide-y divide-[#1e2333]">
          {incidents.map((inc) => (
            ...
            >
              ...
              <span className="text-xs text-gray-600 shrink-0">View details</span>
            </Link>
          ))}
        </div>
      )}
